			...
			<div className="row">
				...
				<div className="ltn__blog-list-wrap">
					...
					<div className="ltn__blog-img">
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/31.jpg"} alt="Image" loading="lazy"
                      width={100}
                            height={100}  /></Link>
					</div>
					...
					<div className="ltn__video-img">
						<img src={publicUrl+"assets/img/blog/32.jpg"} alt="video popup bg image" loading="lazy"
                      width={100}
                            height={100}  />
					...
					<div className="ltn__blog-gallery-active slick-arrow-1 slick-arrow-1-inner">
						...
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/33.jpg"} alt="Image" loading="lazy"
                      width={100}
                            height={100}  /></Link>
						</div>
						<div className="ltn__blog-gallery-item">
