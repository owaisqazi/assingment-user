							...
							<div className="ltn__blog-list-wrap">
								...
								<div className="ltn__blog-item ltn__blog-item-5 go-top">
									<div className="ltn__blog-img">
										<Link to="/blog-details"><img src={publicUrl + "assets/img/blog/31.jpg"} alt="Images" loading="lazy"
											width={100}
											height={100} /></Link>
									</div>
											...
											<div className="ltn__blog-meta">
												<ul>
													<li className="ltn__blog-author">
														<Link to="/blog-grid"><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" loading="lazy"
															width={100}
															height={100} />By: Ethan</Link>
													</li>
												</ul>
											</div>
								...
								<div className="ltn__blog-item ltn__blog-item-5 ltn__blog-item-video">
									<div className="ltn__video-img">
										<img src={publicUrl + "assets/img/blog/32.jpg"} alt="videopopupbgimage" loading="lazy"
											width={100}
											height={100} />
								...
								<div className="ltn__blog-item ltn__blog-item-5 ltn__blog-item-gallery">
									<div className="ltn__blog-gallery-active slick-arrow-1 slick-arrow-1-inner">
										<div className="ltn__blog-gallery-item">
											<Link to="/blog-details"><img src={publicUrl + "assets/img/blog/33.jpg"} alt="Images" loading="lazy"
												width={100}
												height={100} /></Link>
										</div>
										<div className="ltn__blog-gallery-item">
											<Link to="/blog-details"><img src={publicUrl + "assets/img/blog/34.jpg"} alt="Images" loading="lazy"
												width={100}
												height={100} /></Link>
										</div>
										<div className="ltn__blog-gallery-item">
