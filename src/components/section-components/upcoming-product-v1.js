			          ...
			          <div className="row">
			            <div className="col-lg-7">
			              <div className="ltn__upcoming-project-img">
			                <img src={publicUrl+"assets/img/product-3/3.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
			              </div>
			            </div>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__upcoming-project-item">
			          <div className="row">
			            <div className="col-lg-7">
			              <div className="ltn__upcoming-project-img">
			                <img src={publicUrl+"assets/img/product-3/2.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
			              </div>
			            </div>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__upcoming-project-item">
			          <div className="row">
			            <div className="col-lg-7">
			              <div className="ltn__upcoming-project-img">
			                <img src={publicUrl+"assets/img/product-3/7.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
			              </div>
			            </div>
