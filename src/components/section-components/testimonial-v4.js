    ...
    return <div className="ltn__testimonial-area bg-image pt-115 pb-70" data-bs-bg={publicUrl+"assets/img/bg/8.jpg"}>
				...
				<div className="row ltn__testimonial-slider-2-active slick-arrow-3">
					...
					<div className="ltn__testimonial-item ltn__testimonial-item-3">
						...
						<img src={publicUrl+"assets/img/blog/4.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
						</div>
						...
						<div className="ltn__testimoni-info-inner">
							...
							<img src={publicUrl+"assets/img/testimonial/1.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
							</div>
					...
					<div className="ltn__testimonial-item ltn__testimonial-item-3">
						<div className="ltn__testimonial-img">
						<img src={publicUrl+"assets/img/blog/5.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
						</div>
						<div className="ltn__testimoni-info">
						...
						<div className="ltn__testimoni-info-inner">
							<div className="ltn__testimoni-img">
							<img src={publicUrl+"assets/img/testimonial/2.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
							</div>
							<div className="ltn__testimoni-name-designation">
					...
					<div className="ltn__testimonial-item ltn__testimonial-item-3">
						<div className="ltn__testimonial-img">
						<img src={publicUrl+"assets/img/blog/6.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
						</div>
						<div className="ltn__testimoni-info">
					...
					<div className="ltn__testimonial-item ltn__testimonial-item-3">
						<div className="ltn__testimonial-img">
						<img src={publicUrl+"assets/img/blog/1.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
						</div>
						<div className="ltn__testimoni-info">
						...
						<div className="ltn__testimoni-info-inner">
							<div className="ltn__testimoni-img">
							<img src={publicUrl+"assets/img/testimonial/4.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
							</div>
							<div className="ltn__testimoni-name-designation">
					...
					<div className="ltn__testimonial-item ltn__testimonial-item-3">
						<div className="ltn__testimonial-img">
						<img src={publicUrl+"assets/img/blog/2.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
						</div>
						<div className="ltn__testimoni-info">
