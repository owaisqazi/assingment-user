				...
				<div className="ltn__product-slider-area ltn__product-gutter pt-115 pb-70">
					...
					<div className="row ltn__product-slider-item-three-active--- slick-arrow-1">
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							...
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/1.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
								<Link to="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
								</div>
							</div>
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img go-top">
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/2.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
                      ...
                      width={100}
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img go-top">
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/3.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
                      ...
                      width={100}
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img go-top">
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/4.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
                      ...
                      width={100}
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img go-top">
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/5.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
                      ...
                      width={100}
						...
						<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img go-top">
							<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/6.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
							<div className="real-estate-agent">
								<div className="agent-img">
							...
							<div className="ltn__quick-view-modal-inner">
								...
								<div className="row">
									...
									<div className="modal-product-img">
										<img src={publicUrl+"assets/img/product/7.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</div>
									...
									<div className="additional-info d-none">
										...
										<img src={publicUrl+"assets/img/icons/payment.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
										</div>
									</div>
						...
						<div className="modal-content">
							...
							<div className="ltn__quick-view-modal-inner">
								...
								<div className="row">
									...
									<div className="modal-product-img">
										<img src={publicUrl+"assets/img/product/4.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</div>
									</div>
						...
						<div className="modal-content">
							...
							<div className="ltn__quick-view-modal-inner">
								...
								<div className="row">
									<div className="col-12">
									<div className="modal-product-img">
										<img src={publicUrl+"assets/img/product/1.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</div>
									<div className="modal-product-info go-top">
