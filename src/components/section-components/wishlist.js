					...
					<div className="shoping-cart-inner">
						...
						<table className="table">
							...
							<tr>
								...
								<Link to="/product-details/"><img src={publicUrl+"assets/img/product/1.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
								</td>
							...
							<tr>
								<td className="cart-product-remove">x</td>
								<td className="cart-product-image">
								<Link to="/product-details/"><img src={publicUrl+"assets/img/product/2.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
								</td>
								<td className="cart-product-info">
							...
							<tr>
								<td className="cart-product-remove">x</td>
								<td className="cart-product-image">
								<Link to="/product-details/"><img src={publicUrl+"assets/img/product/4.png"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
								</td>
								<td className="cart-product-info">
