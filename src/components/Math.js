...
const Math = () => {
    return (
        <>
            ...
            <BannerV5
                headerTitle={"Math Assignments Help"}
                typeWriterValue={[
