							...
							<div className="ltn__main-menu">
								...
								<ul className="sub-menu menu-pages-img-show">
									<li>
										...
										<img src={publicUrl+"assets/img/home-demos/home-1.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</li>
									<li>
										<Link to="/home-v2">Home Style 02</Link>
										<img src={publicUrl+"assets/img/home-demos/home-2.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</li>
									<li>
										<Link to="/home-v3">Home Style 03</Link>
										<img src={publicUrl+"assets/img/home-demos/home-3.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</li>
									<li>
									<Link to="/home-v4">Home Style 04</Link>
									<img src={publicUrl+"assets/img/home-demos/home-4.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v5">Home Style 05 <span className="menu-item-badge">video</span></Link>
										<img src={publicUrl+"assets/img/home-demos/home-5.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v6">Home Style 06</Link>
										<img src={publicUrl+"assets/img/home-demos/home-6.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v7">Home Style 07</Link>
										<img src={publicUrl+"assets/img/home-demos/home-7.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v8">Home Style 08</Link>
										<img src={publicUrl+"assets/img/home-demos/home-8.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v9">Home Style 09</Link>
										<img src={publicUrl+"assets/img/home-demos/home-9.jpg" } alt="#" loading="lazy"
                      width={100}
                            height={100}  /> 
									</li>
									<li>
										<Link to="/home-v10">Home Style 10</Link>
										<img src={publicUrl+"assets/img/home-demos/home-11.jpg"}  alt="#" loading="lazy"
                      width={100}
                            height={100}  />
									</li>
								</ul>
								...
								<ul className="mega-menu">
									...
									<li><Link to="/shop"><img src={publicUrl+"assets/img/banner/menu-banner-1.jpg"} alt="#" loading="lazy"
                      width={100}
                            height={100}  /></Link>
									</li>
								</ul>
